...
function ApplyJob() {
  ...
  function handleSubmit(e){
    ...
    Email.send({
      ...
      I hope this email finds you well. My name is ${name} and I am reaching out to express my interest in the ${data.profile} position that I saw listed on EasyHired.
